...
export default function WhatsAppFAB() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      {hovered && (
        <span className="absolute right-16 bg-abyss text-white font-body text-xs font-medium px-3 py-1.5 rounded-lg whitespace-nowrap pointer-events-none shadow-md">
          💬 Chat on WhatsApp
          <span className="absolute right-[-6px] top-1/2 -translate-y-1/2 border-4 border-transparent border-l-abyss" />
        </span>
      )}
